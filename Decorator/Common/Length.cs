...
public class Length
{
    ...
    public Length Scale(decimal factor) =>
        new Length(this.Meters * factor);

    public Length Max(Length other) =>
        this.Meters >= other.Meters ? this : other;

    public static Length operator +(Length a, Length b) =>
        new Length(a.Meters + b.Meters);

    public static Length operator *(Length length, decimal factor) =>
        new Length(length.Meters * factor);
    ...
    private static string ToString(string separator, IEnumerable<Length> lengths,
        (decimal factor, string unit) scale) =>
